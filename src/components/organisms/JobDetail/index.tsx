          ...
          <div>
            ...
            <div className="text-gray-500 mt-3">
              <p>
                ...
                Officia quos magnam distinctio, enim facere reiciendis minima
                harum dolor, explicabo magni nam expedita placeat iste. Impedit
                cupiditate ea quia autem modi.
              </p>
            </div>
          </div>
          <div>
        ...
        <div>
          ...
          <div className="mb-10 space-y-5">
            ...
            <div className="flex justify-between">
              ...
              <div className="font-semibold">12 Sep 2023</div>
            </div>
            <div className="flex justify-between">
